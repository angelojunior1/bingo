...
function desenharCartela(jogador) {
    ...
    //Elemento de texto para nome do jogador
...
function gerarCartela() {
    var cartela = [gerarColuna(5, 1, 15), gerarColuna(5, 16, 30),
    gerarColuna(5, 31, 45), gerarColuna(5, 46, 60), gerarColuna(5, 61, 75)];
